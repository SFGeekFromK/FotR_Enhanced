...
function Start_Cinematic_Intro_Rep()
	...
	player_dauntless = Spawn_Unit(Find_Object_Type("Venator_OFC"), dauntless_marker, p_republic)
	...
	player_pioneer = Spawn_Unit(Find_Object_Type("Venator_OFC"), pioneer_marker, p_republic)
